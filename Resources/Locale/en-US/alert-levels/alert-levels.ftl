...
alert-level-dzeta = Dzeta
alert-level-dzeta-announcement = Attention! Code Dzeta! You managed to destroy the death squad and thought that was it? Nope. We've targeted you with January Bluespace missiles, give us your order. Glory to NanoTrasen.
alert-level-dzeta-instructions = Nothing can help you anymore, pray.

alert-level-black = Black
alert-level-black-announcement = Alert! Code Black! A critical man-made disaster has occurred. Singularity or Tesla is on the loose. Call an evacuation shuttle and evacuate the station NOW.
alert-level-black-instructions = THE STATION HAS BEEN DECLARED UNSALVABLE. INSTRUCTIONS TO ALL DEPARTMENTS: IMMEDIATELY DROP WORK, FIND A CROWBAR AND A SPACESUIT, STAY IN GROUPS, AND PROCEED TO THE CARGO OR EVACUATION SHUTTLE. GLORY NANOTRACEN.